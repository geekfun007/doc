module byte.dance/article

go 1.22.2

replace byte.dance/kitex_gen => ../../kitex_gen

replace byte.dance/pkg => ../../pkg

require (
	byte.dance/kitex_gen v0.0.0-00010101000000-000000000000
	byte.dance/pkg v0.0.0-00010101000000-000000000000
